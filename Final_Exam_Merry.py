...
user1 = Customer("Merry", 123456789)
user2 = Customer("Areebah", 987654321)

user1.create_account() # Merry Account created succesfully. Your account number is: 1000
user2.create_account() # Areebah Account created succesfully. Your account number is: 1001
...
user1.transfer(1000, user2) # Successful Money Transfer from Merry to Areebah
...
admin1 = Admin("Mustaeen", 998877665)

admin1.create_account() # Mustaeen Account created succesfully. Your account number is: 10
